...
import com.example.advanceddictionary.Adapters.MeaningAdapter;
import com.example.advanceddictionary.Adapters.PhoneticsAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void showData (APIResponse apiResponse) {
        ...
        PhoneticsAdapter phoneticsAdapter = new PhoneticsAdapter(this, apiResponse.getPhonetics());
        recycler_phonetics.setAdapter(phoneticsAdapter);
        recycler_meanings.setHasFixedSize(true);
        recycler_meanings.setLayoutManager(new GridLayoutManager(this, 1));
        MeaningAdapter meaningAdapter = new MeaningAdapter(this, apiResponse.getMeanings());
