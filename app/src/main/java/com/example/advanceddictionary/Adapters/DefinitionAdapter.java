package com.example.advanceddictionary.Adapters;
...
import com.example.advanceddictionary.Models.Definitions;
import com.example.advanceddictionary.R;
import com.example.advanceddictionary.ViewHolders.DefinitionViewHolder;
...
public class DefinitionAdapter extends RecyclerView.Adapter<DefinitionViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DefinitionViewHolder holder, int position) {
        holder.textView_definition.setText("Definitioin : "+definitionsList.get(position).getDefinition());
